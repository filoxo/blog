...
The assumption here is that microfrontends disregard performance in favor of DX. Additionally, it's true that 2 is greater than 1; shipping multiple runtimes without prudence and care is going to be bad. But I'd argue though that bad performance comes down to implementation, not architecture.
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Back end devs: Front end isn&#39;t real engineering.<br/><br/>Front end devs: *Bring engineering principles to front end*<br/><br/>Back end devs: Front end is too complicated.</p>&mdash; Mark Dalgleish (@markdalgleish) <a href="https://twitter.com/markdalgleish/status/1150488911744917505?ref_src=twsrc%5Etfw">July 14, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>


If these features appeal to you and your organization, check out [Single-spa](https://single-spa.js.org/) and it's [recommended setup](https://single-spa.js.org/docs/faq.html#is-there-a-recommended-setup) that leverages the aforementioned import-maps. Give an emerging pattern like microservices in the browser a chance. Don't buck against it just because it isn't the way you've done things, and let go of your bad assumptions.